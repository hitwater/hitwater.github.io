...
var HTMLskillsStart = '<h3 id="skills-h3">Skills at a Glance:</h3><span><id="skills" class="flex-box"></span>';
var HTMLskills = '<class="flex-item"><div class="white-text">%data%</div>';
